...
\hhline{|-|-~}
	...
	&\gnumericPB{\raggedright}\gnumbox[l]{checking}
\\
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{AB (c)}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{4.12}}
	&\gnumericPB{\raggedright}\gnumbox[l]{ld}
\\
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{BC (a)}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{4.47}}
	&\gnumericPB{\raggedright}\gnumbox[l]{ju}
\\
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\gnumericPB{\raggedright}\gnumbox[l]{ndh}
\\
\hhline{|-|-|~}
\end{longtable}
