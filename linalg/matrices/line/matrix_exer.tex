...
\begin{enumerate}
  \item 
  \item 
  \item \input{solutions/aug/2/4/2/Assignment-2.tex}
  \item \input{solutions/aug/2/4/4/Assignment-2.tex}
\end{enumerate}
...
\solution
\begin{enumerate}
\item \input{solutions/aug/2/6/1/Assignment-2.tex}
\end{enumerate}
...
\solution
\input{solutions/aug/2/11/Assignment2.tex}
...
\item If$ A^{'}$=\myvec{-2 &3\\1 &2} and B=\myvec{-1 &0\\1 &2},then find that $(A+2B)^{'}$\\
  ...
  \begin{enumerate}
    \item \input{solutions/aug/2/22/1/main.tex}
    \item \input{solutions/aug/2/22/1/2.tex}
  \end{enumerate}
...
\\
\solution
\input{solutions/aug/2/70/Assignment2.tex}
