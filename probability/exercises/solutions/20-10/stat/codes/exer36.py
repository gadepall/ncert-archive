...
import xlsxwriter
#reding the table
loc=("/home/krishnajakodali/probstat/stat/tables/exer36/inp36.xlsx")
wb=xlrd.open_workbook(loc)
sheet=wb.sheet_by_index(0)
#outpul excel table
workbook=xlsxwriter.Workbook('/home/krishnajakodali/probstat/stat/tables/exer36/out36.xlsx')
