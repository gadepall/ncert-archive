...
\hhline{|-|-}
	...
	{\gnumericPB{\centering}\gnumbox{\textbf{Age (in years)}}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{\textbf{No.of children}}}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{7- 10}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{15- 17}}
	&\multicolumn{1}{p{\gnumericColB}|}%
