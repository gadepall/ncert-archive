...
\hhline{|-|-~}
	...
	{\gnumericPB{\raggedright}\gnumbox[l]{Class}}
...
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{2.0-2.5}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{2.5-3.0}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{3.0-3.5}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{3.5-4.0}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{4.0-4.5}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{4.5-5.0}}
	&\multicolumn{1}{p{\gnumericColB}|}%
